...
async def get_contact(cnt_id: int, db: AsyncSession = Depends(get_db)):
    service = ContactsService(db)
...
async def update_contact(
    cnt_id: int, body: ContactsUpdateSchema, db: AsyncSession = Depends(get_db)
):
    service = ContactsService(db)
...
async def delete_contact(cnt_id: int, db: AsyncSession = Depends(get_db)):
    service = ContactsService(db)
